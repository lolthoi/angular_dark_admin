...
namespace BikeStoreSimple.API.Models
{
    public partial class BikeStoreContext : DbContext
    {
        ...
        //                optionsBuilder.UseSqlServer("Server=3SI-L065-DUONGH\\SQLEXPRESS;Database=BikeStore;Trusted_Connection=True;");
        //            }
        //        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<OrderItem>(entity =>
            {
                entity.HasKey(e => new { e.OrderId, e.ItemId })
                    .HasName("PK__order_it__837942D483353854");
            ...
            modelBuilder.Entity<Staff>(entity =>
            {
                ...
                entity.HasIndex(e => e.Email, "UQ__staffs__AB6E6164893B26A7")
                    .IsUnique();
            ...
            modelBuilder.Entity<Stock>(entity =>
            {
                entity.HasKey(e => new { e.StoreId, e.ProductId })
                    .HasName("PK__stocks__E68284D3F03E7408");
